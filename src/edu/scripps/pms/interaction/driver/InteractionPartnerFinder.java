...
/**
 * @author Tao Xu 
 * @version $Id: InteractionPartnerFinder.java,v 1.1 2005/05/09 23:41:34 taoxu Exp $
...
public class InteractionPartnerFinder {

    private static final String USAGE = "Usage: java InteractionPartnerFinder proteinListFile taxonId";
    ...
    public InteractionPartnerFinder(String dbName, String proteinListFile)
    ...
    public static void main(String [] args) {
        try {
            InteractionPartnerFinder ipf = new InteractionPartnerFinder("bind", args[0]);
            int taxonId = Integer.parseInt(args[1]);
            ipf.outputResult(taxonId);
    ...
    public void outputResult(int taxonId) throws SQLException, IOException {
        ...
        for (String shortLabel : proteinList) {
            ...
            if (ig.isIncluded(shortLabel, taxonId)) {
