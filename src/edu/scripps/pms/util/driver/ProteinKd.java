...
public class ProteinKd {
	...
	System.out.println(
		"usage: java ProteinKd <accfile> <fastafile>");
	System.exit( -1);
    }
...
//System.out.println("Protein Length: " + (lastIndex + 1) + "\tleftEnd: " + leftEnd + "\trightEnd: " + rightEnd +"\tmass: " + precmass + "\thighLimit: " + highLimit + "\tlowLimit: " + lowLimit);
	...
	try {
            ...
            String acsetfile = args[0];
            String fastaFileName = args[1];

	    br = new BufferedReader(new FileReader(acsetfile));
