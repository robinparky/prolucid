...
// 
public class PrecursorIntensity
{
	...
	try{
		...
		StringBuffer sb = new StringBuffer(40);
	        ...
	        {
	    	    returnStr = getPrecursorIntensity(temp[i]);
    ...
    public String getPrecursorIntensity(String str)
    {
...
//System.out.println("return: " + intens[scannum]);
    ...
    {
	PrecursorIntensity reader = new PrecursorIntensity();
