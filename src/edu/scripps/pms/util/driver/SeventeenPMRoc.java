 ...
 *
 * @author Tao Xu 
 * @version $Id: SeventeenPMRoc.java,v 1.6 2008/01/17 19:46:57 taoxu Exp $
 */

import edu.scripps.pms.mspid.MassCalculator;

public class SeventeenPMRoc {
    ...
    public static void main(String args[]) throws IOException {
         ...
         SeventeenPMRoc roc = new SeventeenPMRoc(locus, charge, interval);
    ...
    public SeventeenPMRoc(String loc, int charge, int interval) {
        locus = loc;
...
//System.err.println("numElements: " + numElements);
        ...
        int index = 0;
        System.out.println("numTrueHits\tFPF\tTPF\tTPR\tFPR\tPrimaryScore");
        int arrayIndex = 0;
        ...
        fp = numF/(numF+numT+0.0);
        tp = numT/(numT+numF+0.0);
        System.out.println(numF + "\t" + fpfs[arrayIndex] + "\t" + tpfs[arrayIndex] + "\t" + tp + "\t" + fp);
...
//System.out.println("A: " + areaUnderCurve + "\ttpfs: " + tpfs[i] + "\tavg: " + avg + "\tfpf[i]: " + fpfs[i] + "\tfpfs[i=1]: " + fpfs[i-1]);
    ...
    public void sortSqtPeptides() {
        ...
        SQTPeptideSpComparator comparator = new SQTPeptideSpComparator();
