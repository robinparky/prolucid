 ...
 *
 * @author Tao Xu 
 * @version $Id: SqtCheker.java,v 1.1 2012/10/23 17:56:00 taoxu Exp $
 */
public class SqtCheker
{
    ...
    {
         SqtCheker reader = new SqtCheker( args[0] );
...
e.printStackTrace();
    ...
    public SqtCheker(String fileName) throws IOException
    {
