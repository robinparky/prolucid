...
// 
public class PrecursorSignal2Noise {
	...
	try{
		...
		StringBuffer sb = new StringBuffer(40);
	        ...
	        for(int i = 1; i < temp.length; i+=12)
	        {
	    	    returnStr = getPrecursorSignal2Noise(temp[i]);
    ...
    public String getPrecursorSignal2Noise(String str)
    {
...
//System.out.println("return: " + signalnoises[scannum]);
    ...
    {
	PrecursorSignal2Noise reader = new PrecursorSignal2Noise();
