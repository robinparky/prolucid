...
*/
                ...
                //double score = -Math.log10(DistributionCalculator.getBinomialSum(prob, p.getNumPeaks(), p.getNumPeaksMatched()));
            ...
            calcPrimaryScoreDeviation(); // change to calc SD of XCorr 
