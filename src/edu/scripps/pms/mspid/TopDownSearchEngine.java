 ...
 * This is the source file for edu.scripps.pms.mspid.TopDownSearchEngine
 * @author Tao Xu
...
class TopDownSearchEngine {
    ...
    private static final String USAGE = "java TopDownSearchEngine ms2file";
    ...
    public List<SearchResult> search(PeakList peaks) throws IOException {
        ...
        //PeptideHit.setFragMasses(mc.getFragMasses()); makes no big difference
            startTime = System.currentTimeMillis();
                double maxFragment = peaks.getMaxM2z() + 10; 
                ProcessedPeakList ppl = new Charge2PeakList(peaks, new Zline(1, maxFragment), params, mc);
    ...
    public static void main(String args[]) throws Exception {
        try {
            ...
            ProteinDatabase pd = new ProteinDatabase(sp.getDbName());
