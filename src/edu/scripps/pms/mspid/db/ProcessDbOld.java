/**
 * @file ProcessDbOld.java
 * This is the source file for edu.scripps.pms.mspid.ProcessDbOld
 * @author Tao Xu
 * @date $Date: 2005/10/11 21:55:58 $
 */
...
class ProcessDbOld {
    private static final String USAGE= "---Usage: java ProcessDbOld dbfile ---";
    ...
    public ProcessDbOld(String fasta, SearchParams sp) throws IOException { 
    ...
    private void swap(int indexa, int indexb, byte [] bytes) {
        copyOut(indexa, b); // copy data out into temp
    ...
    public static void main(String args[]) throws Exception {
        try { 
            ...
            timer.startTiming();
            ProcessDbOld se = new ProcessDbOld(fastaFile, sp);
