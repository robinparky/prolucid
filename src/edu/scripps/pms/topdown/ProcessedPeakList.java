...
public class ProcessedPeakList {
    ...
    public static final int PRECISIONFACTOR = 1; // for sp process
...
//    protected int highM2z;
    ...
    protected double yDbinwidthStart;
    protected double bDbinwidthStart;
...
//System.out.println("bStart: " + bStart);
    ...
    public double getDbinwidthYStart() {
        return yDbinwidthStart;
    }
    public double getDbinwidthBStart() {
        return bDbinwidthStart;
    }
    ...
    // for topdown
    public ProcessedPeakList(PeakList peaklist, SearchParams sp, MassCalculator mc) {
 ...
 //       highM2z = (int)((peaks.getMaxM2z()+10)*MassSpecConstants.DBINWIDTH + 0.5f);
        ...
        //yStart = MassSpecConstants.MASSH3O + params.getStaticCTermMod();
        //bStart = MassSpecConstants.MASSH + params.getStaticNTermMod();
        yStart = MassSpecConstants.MASSH2O + params.getStaticCTermMod();
        bStart = params.getStaticNTermMod();
        yDbinwidthStart = yStart*MassSpecConstants.DBINWIDTH;
        bDbinwidthStart = bStart*MassSpecConstants.DBINWIDTH;
      //System.out.println("yStart: " + yStart + "\tbStart: " + bStart); 
        ...
        boolMasses = new boolean[(int) (prcMass+params.getMaxMassShift()+1020.5)*PRECISIONFACTOR]; // = new boolean[MAXNUMPEAKS]; // boolean representation of masses
        intensityVal = new double [(int)(prcMass+params.getMaxMassShift()+1020.5)*PRECISIONFACTOR + 100]; // = new double[MAXNUMPEAKS];

        fragTolerance = params.getFragmentTolerance()/1000.0f; // change from ppm to .4 etc.
        minimumPeptideLength = params.getMinimumProteinLength() - 2; // to avoid +1 and >= 
...
//System.out.println("Max intens: " + inten + "\tmaxTransformedIntens: " + maxTransformedInten);
    ...
    public ProcessedPeakList(PeakList peaklist, Zline z, SearchParams sp, MassCalculator mc) {
        ...
        chargeState = z.getChargeState() > 2? 3 : 2;
        //System.out.println("Scan#: " + peaks.getLoscan() + "\t+" + z.getChargeState() + "\tNumPeaks: " + peaks.numPeaks()+ "\tm2z: " + z.getM2z() + "ptrue: " + pTrue);
        params = sp;
        masses = mc.getFragMasses(MassSpecConstants.DBINWIDTH);
 //       lowM2z = (int)((peaks.getMinM2z()-10)*MassSpecConstants.DBINWIDTH + 0.5f);
...
//System.out.println("Number of Theor Peaks: " + theorPeaks.size());
        double sumProduct = 0;
