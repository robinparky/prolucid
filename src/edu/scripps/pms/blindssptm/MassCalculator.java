 ...
 * This is the source file for edu.scripps.pms.blindptm.MassCalculator
 * @author Tao Xu
 * @date $Date
 */
...
/*
 * MassCalculator assigns masses of amino acids
 * dependending on the mode ISOTP
 * ISOTP = 0 precursor/fragment ion masses averaged
 * ISOTP = 1 precursor mono, fragment averaged
 * ISOTP = 2 precursor averaged, fragment mono
 * ISOTP = 3 precursor/fragment ion masses mono
*/
...
//    public static final double H3OMASS = H2OMASS + HMASS;
    ...
    public double getPrecursorMass(String sequence) {
        ...
        double mass = MassSpecConstants.MASSH2O + MassSpecConstants.MASSH;
        for(int i = 0; i < len; i++) {
    ...
    public static double getMonoMass(String sequence, int chargeState) {
        int len = sequence.length();
        double mass = MassSpecConstants.MASSH2O + MassSpecConstants.MASSH * (chargeState-1);
        for(int i = 0; i < len; i++) {
