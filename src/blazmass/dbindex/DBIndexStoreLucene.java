...
public class DBIndexStoreLucene implements DBIndexStore {
    ...
    private final Field massField = new FloatField(FIELDS.MASS.toString(), 0f, Field.Store.YES);
    ...
    //private final Field seqField = new StringField(FIELDS.SEQUENCE.toString(), "", Field.Store.NO);
    //private final Field lrField = new StringField(FIELDS.LR.toString(), "", Field.Store.NO);
    //private final Field rrField = new StringField(FIELDS.RR.toString(), "", Field.Store.NO);
...
//	document.add(new Field(FIELD_PATH, path, Field.Store.YES, Field.Index.UN_TOKENIZED));
    ...
    private void initReader() throws DBIndexStoreException {
        ...
        try {
            ...
            //TODO maybe in index mode, TOOD fix, may need to know the mode how to initialize 
    ...
    @Override
    public void addSequence(float precMass, int sequenceOffset, int sequenceLen, String sequence, String resLeft, String resRight, long proteinId) throws DBIndexStoreException {
        ...
        massField.setFloatValue(precMass);
    ...
    public List<IndexedSequence> getSequences(float precMass, float tolerance) throws DBIndexStoreException {
        ...
        //QueryParser queryParser = new QueryParser(LUCENE_VERSION, searchField, readAnalyzer);
    ...
    private class ResultsCollector extends Collector {
        ...
        public void collect(int i) throws IOException {
            ...
            //System.out.print("prot id: " + protId + " offset: " + offsetI + " len: " + lenI);
            ...
            final IndexedSeqInternal tempSequence = new IndexedSeqInternal(massF, offsetI, lenI, protIdI, peptideSequence);
